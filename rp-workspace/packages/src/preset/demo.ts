 ...
 */
import { emptyPreset, type RPPreset } from './schema.ts'

/** 直答型示范预设（场景 A 走查载体） */
export function demoDirectPreset(): RPPreset {
  const p = emptyPreset('rp-demo-direct', '示范 · 直答型')
...
export function demoLightAgentPreset(): RPPreset {
