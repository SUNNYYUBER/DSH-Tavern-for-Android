...
exports.extractCardJsonFromPng = extractCardJsonFromPng;
exports.parseCharacterCard = parseCharacterCard;
exports.importCharacterPng = importCharacterPng;
exports.importCharacterJson = importCharacterJson;
exports.summarizeBundle = summarizeBundle;
...
function extractCardJsonFromPng(bytes) {
    ...
    while (pos + 12 <= bytes.length) {
        ...
        if (type === 'tEXt') {
            ...
            // 找 null 分隔符
            let kwEnd = dataStart;
            while (kwEnd < dataStart + length && bytes[kwEnd] !== 0)
                kwEnd++;
...
function parseCharacterCard(json, sourceName) {
    ...
    if (rawBook && typeof rawBook === 'object') {
        embeddedBook = (0, entry_ts_1.importLoreBook)(`${str(data.name, sourceName)}::embedded`, rawBook);
    ...
    if (Array.isArray(ext.regex_scripts)) {
        const r = (0, engine_ts_1.importRegexScripts)(ext.regex_scripts);
