...
export declare function dshRpc<T = unknown>(method: string, payload?: unknown): Promise<T>;
...
export declare function rpApi<T = unknown>(path: string, payload?: unknown): Promise<T>;
...
export declare function thApi<T = unknown>(path: string, payload?: unknown): Promise<T>;
/** dsht-plugin-memory 数据面 POST（/dsht-memory/*，同源；settings/expand/summarize） */
export declare function memApi<T = unknown>(path: string, payload?: unknown): Promise<T>;
/** dsht-plugin-memory 数据面 GET（/dsht-memory/*?query；health/status） */
export declare function memGet<T = unknown>(path: string, query: string): Promise<T>;
