...
/** 槽位类型 */
export type SlotType = 'system' | 'marker' | 'skillRef' | 'state' | 'configSummary';
...
export declare const DEFAULT_BUDGET: PresetBudget;
/** 直答型示范预设的骨架（T1.10 的基础） */
export declare function emptyPreset(id: string, displayName: string): RPPreset;
/**
...
export declare function compileSlots(preset: RPPreset): CompiledSlot[];
