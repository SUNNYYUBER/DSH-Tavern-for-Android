...
**v0.2.0 正式版已于 2026-09-20 晚发布**（首个非 pre-release）。

- [x] **npm 首发闭环**：8 包发布（7 运行时包 @0.2.0 + dsh-plugin-lint @0.2.1）
- [x] **口径诚实**：README 中英「验证面速查」表（模拟器/真机/鸿蒙分列）
- ~~真机闭环 / 稳定期~~ → **社区众包项**：B-DEVICE 清单保持开放回填，不再阻塞发版节奏
